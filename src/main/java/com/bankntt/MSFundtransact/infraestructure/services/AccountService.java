...
public class AccountService implements IAccountService {
    ...
    @Override
    public Mono<ResponseEntity<Account>> updatebalancedp(String id, BigDecimal balance) {
        return repository.findById(id).flatMap(a ->
                {
    ...
    @Override
    public Mono<ResponseEntity<Account>> updatebalancewt(String id, BigDecimal balance) {
        return repository.findById(id).flatMap(a ->
                {
    ...
    private final Function<SavingAccountDTO, Mono<Account>> FuctionalSaveAccount = account -> {
